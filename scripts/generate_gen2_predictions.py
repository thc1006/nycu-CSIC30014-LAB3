#!/usr/bin/env python3
"""
Gen2 預測生成器 - 5-Fold 集成
基於訓練完成的 Gen2 模型生成測試集預測
"""
...
def main():
    ...
    model_paths = []
    for fold in range(5):
        model_path = f'outputs/v2l_512_gen2/fold{fold}/best.pt'
    ...
    for fold, model_path in model_paths:
        ...
        output_path = f'data/submission_v2l_512_gen2_fold{fold}.csv'
    ...
    output_path = 'data/submission_gen2_ensemble.csv'
    df.to_csv(output_path, index=False)
